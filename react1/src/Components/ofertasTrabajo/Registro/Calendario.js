    ...
    <div className="bloque_form" id="empresa">
        ...
        <div className='form_group'>
            <div className='input_group'>
                <textarea className={`form_textarea form_input ${st.inputContrast} ${st.inputDark}`} type="text" onChange={handleC} id="calendarioEventos" name="calendarioEventos" defaultValue={inputCalendar} placeholder="  Ejemplo: Fecha límite de aplicaciones, de entrevistas, ..."/>                            
            </div>
        </div>
    </div>
    );
