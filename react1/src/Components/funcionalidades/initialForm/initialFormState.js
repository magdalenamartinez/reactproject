...
useEffect(() => {
    if (userData) {
        setFormValues((prevValues) => ({
            ...
            tlf: userData.tlf || '',
            image: userData.image? `http://localhost:5000/uploads/${userData.image}` : "/images/uploadimage2.png",
            curriculum: userData.curriculum? `http://localhost:5000/download/${userData.curriculum}` : '',
