...
const useInitialFormState = (userData) => {
    const initialState = {
        ...
        image: (userData&&userData.image!='') ? `http://localhost:5000/uploads/${userData.image}` : "../images/uploadimage2.png",
        curriculum: userData ? `http://localhost:5000/download/${userData.curriculum}` : '',
