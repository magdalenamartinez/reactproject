...
const ResetPassword = () => {
    ...
    return (
        <div>
            ...
            <form className="formulario" method="post" action="/changePasswordRoute/change-password" onSubmit={handleSubmit} onInput={ValidateFormulary(fieldsPass)} encType='multipart/form-data'>
