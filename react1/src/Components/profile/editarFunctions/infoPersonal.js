    ...
    return (
        <div className="bloque_form" id="infopersonal">
            ...
            <div className="infopersonal_bloque comun">
                ...
                <Foto onChange={(event) => {handleC(event); InputChange2('imageInput', 'imageShoww'); setDeleteImage(false);}} styleFoto={{display: userData.image ? 'initial' : 'none'}} handleDeleteImage={handleDeleteImage} src={formValues.image}/>
              </div>
